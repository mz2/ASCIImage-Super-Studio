...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        FSArgumentSignature *antialiasArg = [FSArgumentSignature argumentSignatureWithFormat:@"[-a --no-antialias]"];
        ...
        id scaleObj = [package firstObjectForSignature:scaleArg];
        CGFloat scale = scaleObj ? [scaleObj floatValue] : 20.0f;
